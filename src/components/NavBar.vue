      ...
      <div class="flex justify-between h-16">
        <div class="flex items-center">
          ...
          <div class="ml-4 flex items-center">
            <span class="text-xl font-semibold text-primary-600">WorkTracker</span>
          </div>
        </div>
        
        <div class="flex items-center">
          <div class="hidden md:flex flex-col items-end mr-6">
            <span class="text-sm text-neutral-600">{{ formatDate(currentTime) }}</span>
            <span class="text-lg font-medium text-neutral-800">{{ formatTime(currentTime) }}</span>
          </div>
          ...
          <div class="relative">
            ...
            >
              ...
              <span class="inline-flex items-center">
                <span class="h-8 w-8 rounded-full bg-primary-600 flex items-center justify-center text-white mr-2">
