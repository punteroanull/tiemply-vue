...
<template>
  ...
  >
    <div class="flex flex-col h-full">
      ...
      <nav class="flex-1 px-2 py-4 space-y-1">
        ...
        >
          <div 
            ...
            :class="[
              isActive(item.path) ? 'text-primary-600' : 'text-neutral-400 group-hover:text-neutral-500', 
              'mr-3 flex-shrink-0'
            ]"
          ></div>
          {{ item.name }}
      ...
      <div class="p-4 text-center text-xs text-neutral-500 border-t border-neutral-200">
        <p>WorkTracker v1.0.0</p>
